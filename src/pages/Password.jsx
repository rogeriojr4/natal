...
class Password extends Nullstack {
  ...
  renderLogin() {
    return (
      <div class="w-full">
        ...
        <input
          bind={this.password}
          class="w-full px-2 text-xl rounded-md mt-6"
          type="text"
          placeholder="Senha"
        />
        {this.error && (
          <p class="text-dark-red font-medium">
            Oh não, parece que você errou a senha, tente de novo!
          </p>
        )}
    ...
    return (
      <>
        <p class="text-2xl text-white">
          Oi {this.user.name}!! <br /> <br /> Quase lá! Antes de tudo, vamos
          criar uma senha? <br /> <br /> Só para o caso <s>da madrinha</s> de
          alguém curioso querer ver o seu amigo secreto 🤓
          <br />
          <br />
  ...
  render() {
    return (
      <>
        {this.hasPassword === null || this.loading ? (
          <LoadingScreen />
        ) : (
